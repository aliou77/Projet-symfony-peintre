 ...
 */
final class Version20230408224122 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE peinture ADD user_id INT NOT NULL, CHANGE date_publication date_publication DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE peinture DROP user_id, CHANGE date_publication date_publication DATETIME NOT NULL');
    }
}
